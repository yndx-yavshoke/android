...
class RegisterScreenTestsWithContent {
    ...
    // Тест на регистрацию без password
    @Test
    ...
    // Тест на повторную регистрацию с email
    @Test
    ...
    // Тест на регитсрацию без домена
    @Test
    ...
    // Проверка наличия всх элементов интерфейса
    @Test
