...
// Проверка экрана редактирования профиля
@RunWith(AndroidJUnit4::class)
class EditeScreenTestsWithSetContent {

    // Правило тестирования Compose-элементов
    @get: Rule
    val composeTestRule  = createComposeRule()

    private lateinit var editScreen: EditorScreenPageObject

    // Настройка: получить контекст приложения, выполнить  логин пользователя, иниц репозиторий и ViewModel, установить Сщьзщыу-контент, иниц Page Object 
    @Before
    fun setUp() {
    ...
    // Имя до 50 символов: тест ввод 51 символа, ожидание сообщ об ошибке, проверка отображения сообщения
    @Test
    ...
    // Проверка видимости всех элементов: заголовок экрана, поле ввода, кнопка сохранить, ввод пустого имени, ввод имени, кнопка отмена
    @Test
...
// Проверка экрана редактирования профиля в контексте всего приложения
@RunWith(AndroidJUnit4::class)
