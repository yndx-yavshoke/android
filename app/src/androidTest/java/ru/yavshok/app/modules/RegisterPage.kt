...
class RegisterPage (private val rule: ComposeTestRule){
    ...
    private val returnButton = Tags.RegisterScreen.returnButton
    private val registerButton = Tags.RegisterScreen.registerButton
    private val fieldError  = Tags.RegisterScreen.fieldError
    ...
    fun ageIs(value: String){
        rule.onNodeWithTag(ageTextField).assertTextEquals(value)
    }
