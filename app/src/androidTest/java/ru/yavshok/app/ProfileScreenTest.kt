...
class ProfileScreenTest {
    ...
    fun logoutButtonShouldNavigateToMainScreen() {
        ...
        composeRule.onNodeWithTag(Tags.LoginScreen.emailTextField).performTextInput("asda@gmail.com")
    ...
    @Test
    fun editProfileButtonShouldNavigateToEditScreen(){
        composeRule.waitUntilAtLeastOneExists(
            timeoutMillis = 5_000L,
            matcher = hasTestTag(Tags.MainScreen.screenTitle)
        )
    ...
    @Test
    fun profileHasNicknameAndSubTitle() {
        composeRule.waitUntilAtLeastOneExists(
            timeoutMillis = 5_000L,
            matcher = hasTestTag(Tags.MainScreen.screenTitle)
        )
        ...
        composeRule.onNodeWithTag(Tags.LoginScreen.screenTitle).assertDoesNotExist()
        composeRule.onNodeWithTag(Tags.ProfileScreen.editProfileButton).assertIsDisplayed()
        composeRule.onNodeWithTag(Tags.ProfileScreen.userNickname).assertIsDisplayed()
        composeRule.onNodeWithTag(Tags.ProfileScreen.subTitle).assertIsDisplayed()
    }
}