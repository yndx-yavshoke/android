        ...
        Column(
            ...
            if (isEmailExists) {
                ...
                Text(
                    ...
                    fontSize = 30.sp,
                    fontWeight = FontWeight.Bold,
                    modifier = Modifier.padding(bottom = 16.dp).testTag(Tags.MainScreen.loginSuccessText)
                )
            ...
            if (!isEmailExists) {
                errorMessage?.let { message ->
                    Text(
                        ...
                        color = Color.Red,
                        fontSize = 30.sp,
                        modifier = Modifier.padding(bottom = 16.dp).testTag(Tags.MainScreen.loginWrongText)
                    )
                }
            }
            ...
            CustomButton(
                ...
                modifier = Modifier.padding(bottom = 12.dp).testTag(Tags.MainScreen.checkButton)
            )
