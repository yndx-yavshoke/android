...
fun LoginScreen(
    ...
    Column(
        ...
        TextField(
            ...
            placeholder = "Email",
            modifier = Modifier
                .testTag(Tags.LoginScreen.emailField)
                .fillMaxWidth(),
        ...
        TextField(
            ...
            placeholder = "Пароль",
            modifier = Modifier
                .testTag(Tags.LoginScreen.passwordField)
                .fillMaxWidth(),
        ...
        uiState.errorMessage?.let { errorMessage ->
            Text(
                ...
                modifier = Modifier
                    .testTag(Tags.LoginScreen.textMessageError)
                    .fillMaxWidth()
            )
        }
        ...
        Button(
            ...
            modifier = Modifier
                .testTag(Tags.LoginScreen.registrationButton)
                .fillMaxWidth(),
            isEnabled = !uiState.isLoading,
            backgroundColor = Color(0xFF007AFF)
        )
