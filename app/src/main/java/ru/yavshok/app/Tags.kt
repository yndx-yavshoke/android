...
object Tags {
    object MainScreen {
        ...
        const val successCatImage = "main_screen.success_cat_image"
        const val successLabel = "main_screen.success_label"
        const val failureLabel ="main_scree.failure_label"
    }
